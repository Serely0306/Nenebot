...
所有图片操作需要配合`/img`指令使用（详见[图片处理](#图片处理)）
...
### 查看语录
`/看语录` `/saying view` `/quote view`
> 随机查看本群已保存的语录，或指定sid查看  

- `/看语录` 随机查看本群一条语录
- `/看语录 123` 查看sid=123的语录


### 查看语录列表
`/看所有语录` `/saying list` `/quote list`
> 查看本群所有已保存的语录列表  
...
### 删除语录
🛠️ `/删语录` `/saying del` `/quote del`
> 删除指定语录  

- `/删语录 123` 删除sid=123的语录
